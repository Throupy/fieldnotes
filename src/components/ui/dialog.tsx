...
function DialogContent({
  ...
  ...props
}: React.ComponentProps<typeof DialogPrimitive.Content> & { noDefaultWidth?: boolean }) {
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          !noDefaultWidth && "w-full max-w-[calc(100%-2rem)] sm:max-w-lg", // Conditional default width
          className
        )}
        {...props}
      >
